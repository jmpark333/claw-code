...
impl TerminalRenderer {
    ...
    pub fn render_markdown(&self, markdown: &str) -> String {
        ...
        // Preserve trailing newlines from hard breaks and paragraphs
    ...
    pub fn markdown_to_ansi(&self, markdown: &str) -> String {
        // Simply render markdown - let terminal handle line wrapping naturally
        // This matches how thinking content is displayed (natural flow)
    ...
    fn push_text(
        ...
        if in_code_block {
            ...
            if let Some(first) = lines.next() {
                state.append_styled(output, first, &self.color_theme);
            }
            for line in lines {
                output.push('\n');
                state.append_styled(output, line, &self.color_theme);
            }
        }
    }
